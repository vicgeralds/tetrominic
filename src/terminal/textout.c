...
{
	/* C0 control codes */
	static unsigned short dingbats[32] = {
	...
	static unsigned short extended[128] = {
		/* Latin characters, box drawing and block characters */
